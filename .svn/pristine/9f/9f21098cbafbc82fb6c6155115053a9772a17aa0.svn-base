  ...
  public function Add_Unit()
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ( $this->model_items_subitems_subitems->Is_Subitem_Exist_By_Designator( $item_guid, $designator ) === true )
        {
        ...
        else
        {
          ...
          else
          {
            ...
            // Add new subitem
            $return_data = $this->model_items_subitems_subitems->Add_Subitem( $unit_data );
