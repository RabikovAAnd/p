<?php
class ControllerWorkplaceCustomersInteractionsAddressDeliveryEdit extends Controller
{
  ...
  public function index()
  {
    ...
    else
    {
      ...
      // Load messages
      $this->messages->Load($this->data, 'workplace', 'customers_interactions_address_delivery_edit', 'index', $this->language->Get_Language_Code());
      ...
      $addresses = $this->model_address_address->Get_Addresses($order['supplier_guid']);
      ...
      $this->data['edit_button_href'] = $this->url->link('workplace/customers/interactions/address/delivery/edit/Edit', 'id=' . $order_id, 'SSL');
  ...
  public function Edit()
  {
    ...
    // Load messages
    $this->messages->Load($this->data, 'workplace', 'customers_interactions_address_delivery_edit', 'Edit', $this->language->Get_Language_Code());
    ...
    if ($this->request->Is_GET_Parameter_ID('id') === false) {
      ...
      $json['error']['id'] = $this->data['workplace_customers_interactions_address_delivery_edit_' . 'id' . '_error'];
    ...
    if ($this->request->Is_POST_Parameter_GUID('address_guid') === false) {
      ...
      // Set error message text
      $json['error']['address_guid'] = $this->data['workplace_customers_interactions_address_delivery_edit_' . 'address_guid' . '_error'];
    ...
    else
    {
      ...
      // Set success code
      $this->model_orders_orders->Update_Delivery_Address($data);
