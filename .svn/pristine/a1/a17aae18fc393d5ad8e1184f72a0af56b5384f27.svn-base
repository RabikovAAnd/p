...
class ModelShippingUps extends Model {
	function getQuote($address) {
		...
		$sql_query .= "WHERE shipping_method.company_id='ups' AND shipping_method_to_country.country_id='" . (int)$address['country_id'] . "' AND (shipping_method_to_country.country_zone_id='" . (int)$address['country_zone_id'] . "' OR shipping_method_to_country.country_zone_id='0')";
