<?php
class ControllerPaymentAccount extends Controller 
{
	...
	public function index() 
	{
		...
		if ($order_info) 
		{
			...
			$this->data['action'] = $this->url->link( 'payment/account/success' );

//			$this->response->Set_HTTP_Output( $this->Render( 'payment/account.tpl' ) );
...
//			$this->response->Set_HTTP_Output( $this->Render( 'payment/account_error.tpl' ) );
...
//		$this->response->Set_HTTP_Output( $this->Render( 'payment/account_success.tpl' ) );
