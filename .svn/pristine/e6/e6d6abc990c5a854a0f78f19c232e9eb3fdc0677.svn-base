...
<div id="content">
  <h1 class="header-list__edit">
    <?php echo $workplace_customers_address_edit_header; ?>
  </h1>
        ...
        <div class="list">
          <div class="address">
            <div>
              <label class="input-text-field">
                ...
                <select id="country_id" name="country_id"
                  title="<?php echo $workplace_customers_address_edit_country_hint; ?>" class="input-send" required>
                  <option value="0">
                    <?php echo $workplace_customers_address_edit_country_placeholder; ?>
                  </option>
              ...
              <label class="input-text-field">
                ...
                <select id="zone_id" name="zone_id" class="input-send"
                  title="<?php echo $workplace_customers_address_edit_region_hint; ?>" required>
                  <option value="0">
                    <?php echo $workplace_customers_address_edit_zone_placeholder; ?>
                  </option>
            ...
            <label class="input-text-field">
              ...
              <input id="postcode" type="text" class="input-send"
                title="<?php echo $workplace_customers_address_edit_postcode_hint; ?>" placeholder="123456"
                value="<?php echo $address['postcode']; ?>">
            </label>
            <label class="input-text-field">
              <?php echo $workplace_customers_address_edit_city_label; ?>
              <input id="city" type="text" class="input-send"
            ...
            <div>
              <label class="input-text-field">
                ...
                <input id="street" type="text" class="input-send"
            ...
            <div>
              <label class="input-text-field">
                ...
                <input id="house" type="text" class="input-send"
                  title="<?php echo $account_address_form_edit_house_number_hint; ?>" placeholder="80"
              ...
              <label class="input-text-field">
                ...
                <input id="building" type="text" class="input-send"
                  title="<?php echo $workplace_customers_address_edit_building_hint; ?>" placeholder="1"
              ...
              <label class="input-text-field">
                ...
                <input id="apartment" type="text" class="input-send"
                  title="<?php echo $workplace_customers_address_edit_apartment_hint; ?>" placeholder="77"
          ...
          <div class="between">
            ...
            <button type="button" id="send-message-button" class="save-changes"
              ...
              onMouseDown="File_Form('<?php echo $save_button_href; ?>')" value="<?php echo $button_save_changes; ?>">
