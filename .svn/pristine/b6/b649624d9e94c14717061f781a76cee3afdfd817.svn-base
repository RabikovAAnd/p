<?php 
class ModelPaymentPrepayment extends Model 
{
  ...
  public function getMethod( $address, $total )
  {
		...
		$sql_query .= "WHERE payment_method.id='2' AND payment_method_to_country.country_id='" . (int)$address['country_id'] . "' AND (payment_method_to_country.country_zone_id='" . (int)$address['country_zone_id'] . "' OR payment_method_to_country.country_zone_id='0')";
