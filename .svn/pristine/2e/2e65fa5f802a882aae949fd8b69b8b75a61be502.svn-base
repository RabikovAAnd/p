      ...
      <div class="info-content-block">
        <div class="list">
          ...
          <label class="checkbox-field">
            <input id="clear_alternatives" type="checkbox" class="input-send"
              title="<?php echo $workplace_items_subitems_edit_clear_alternatives_hint; ?>" />
            <?php echo $workplace_items_subitems_edit_clear_alternatives_label; ?>
          </label>
