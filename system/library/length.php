...
class Length 
{
	...
	public function __construct($registry) 
  {
		...
		$length_class_query = $this->db->query("SELECT * FROM length_class mc LEFT JOIN length_class_description mcd ON (mc.length_class_id = mcd.length_class_id) WHERE mcd.language_id = '0'");
