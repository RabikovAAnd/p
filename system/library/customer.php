...
class Customer
{
  ...
  private const customer_firstname_field_size = 31;
  private const customer_lastname_field_size = 31;
  private const customer_middlename_field_size = 31;
  private const customer_company_name_field_size = 254;
  private const customer_company_short_name_field_size = 254;
  private const customer_password_field_size = 99;

  //----------------------------------------------------------------------------
  // Return maximum string size of customer firstname database field
  //----------------------------------------------------------------------------

  public function Get_Customer_Firstname_Maximum_String_Size()
  {

    // Return maximum string size of customer firstname database field
    return( self::customer_firstname_field_size );

  }

  //----------------------------------------------------------------------------
  // Return maximum string size of customer lastname database field
  //----------------------------------------------------------------------------

  public function Get_Customer_Lastname_Maximum_String_Size()
  {

    // Return maximum string size of customer lastname database field
    return( self::customer_lastname_field_size );

  }

  //----------------------------------------------------------------------------
  // Return maximum string size of customer middlename database field
  //----------------------------------------------------------------------------

  public function Get_Customer_Middlename_Maximum_String_Size()
  {

    // Return maximum string size of customer middlename database field
    return( self::customer_middlename_field_size );

  }

  //----------------------------------------------------------------------------
  // Return maximum string size of customer company name database field
  //----------------------------------------------------------------------------

  public function Get_Customer_Company_Name_Maximum_String_Size()
  {

    // Return maximum string size of customer company name database field
    return( self::customer_company_name_field_size );

  }

 //----------------------------------------------------------------------------
 // Return maximum string size of customer company short name database field
 //----------------------------------------------------------------------------

  public function Get_Customer_Company_Short_Name_Maximum_String_Size()
  {

    // Return maximum string size of customer company short name database field
    return( self::customer_company_short_name_field_size );

  }
  //----------------------------------------------------------------------------
  // Return maximum string size of customer password database field
  //----------------------------------------------------------------------------

  public function Get_Customer_Password_Maximum_String_Size()
  {

    // Return maximum string size of customer password database field
    return( self::customer_password_field_size );
...
*/
  ...
  public function Create( $guid = '', $data = array() )
  {
    ...
    $sql =
      ...
      "SET " .
        ...
        "`customer`.`company_short_name`='" . $this->db->escape( $data[ 'company_short_name' ] ) . "', " .
  ...
  public function Get_Contact_Information( $customer_guid = '' )
  {
    ...
    if ( $result->num_rows != 1 )
    {
      ...
      $contact_data[ 'company_short_name' ] = '';
    ...
    else
    {
      ...
      $contact_data[ 'company_short_name' ] = $result->row[ 'company_short_name' ];
