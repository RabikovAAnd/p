    ...
    <div class="main-area list">
      ...
      <div class="info-content-block list">
        ...
        <div class="table-menu-style">
          ...
          <div class="order-table  table-menu-element">
            ...
            <div class="table-button-menu" style="display: none;">
              <button type="button"  class="red-button" title="<?php echo $workplace_customers_interactions_info_remove_button_hint; ?>"
                onMouseDown="File_Form('<?php echo $line[ 'remove_button_href' ]; ?>')">
                <?php echo $workplace_customers_interactions_info_remove_button_text; ?>
              </button>

              <button type="button"
                title="<?php echo $workplace_customers_interactions_info_change_button_hint; ?>"
                onMouseDown="File_Form('<?php echo $line[ 'change_button_href' ]; ?>')">
        ...
        <div class="end info-content-block">
          <span><b><?php echo $workplace_customers_interactions_info_general_info_net_text . ': '; ?></b><?php echo $order['net']; ?>
          <br>
          <b><?php echo $workplace_customers_interactions_info_general_info_vat_text . ': '; ?></b><?php echo $order['vat']; ?>
          <br>
          <b><?php echo $workplace_customers_interactions_info_general_info_total_text . ': '; ?></b><?php echo $order['total']; ?></span>
        </div>
      </div>
    </div>
  </div>
