...
<div id="content">
  ...
  <h1><?php echo  $workplace_project_edit_header . " " . $project[ 'designator' ] . " - " . $project[ 'name' ]; ?></h1>
    ...
    <div class="main-area">
      <div class="info-content-block ">
        <div class="list">
          ...
          <div class="between">
            <a href="<?php echo $cancel_button_href; ?>"><button type="button" class="inactive-button">
