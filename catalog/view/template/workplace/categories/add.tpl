...
<div id="content">
  <h1>
    <?php echo $workplace_categories_add_header; ?>
  </h1>
        ...
        <div class="list">
          ...
          <label class="checkbox-field">
            <input id="status" type="checkbox" class="input-send"
              title="<?php echo $workplace_categories_add_status_hint; ?>" />
            <?php echo $workplace_categories_add_status_label; ?>
          </label>
         
          <div class="between">
            <a href="<?php echo $cancel_button_href; ?>">
              <button type="button">
                <?php echo $workplace_categories_add_cancel_button_text; ?>
              </button>
            </a>
            <button
              onMouseDown="File_Form('<?php echo $add_button_href; ?>')">
              <?php echo $workplace_categories_add_add_button_text; ?>
            </button>
          </div>
        </div>
