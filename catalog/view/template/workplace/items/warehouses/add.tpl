...
<div id="content">
  ...
  <h1><?php echo $documents_add_header; ?></h1>
      ...
      <div class="info-content-block">
        <div class="list">
          <label class="input-text-field">
            ...
            <input id="file_data" type="file" class="input-send" title="<?php echo $documents_add_file_hint;  ?>">
          </label>
          <label class="input-text-field">
            <?php echo $documents_add_document_type_label; ?>
            <input id="document_type_list" type="text" list="document_type"
              title="<?php echo $documents_add_document_type_hint;  ?>"
              placeholder="<?php echo $documents_add_document_type_placeholder; ?>" required />
            <select id="document_type" size="10" class="input-send">
              <?php foreach ($document_types as $document_type) { ?>
              <option value="<?php echo $document_type['guid']; ?>">
          ...
          <label class="input-text-field">
            ...
            <input id="document_version" type="text" class="input-send"
          ...
          <label class="input-text-field">
            ...
            <input id="document_revision" type="text" class="input-send"
          ...
          <label class="input-text-field">
            ...
            <input id="document_date" type="date" class="input-send"
              title="<?php echo $documents_add_document_date_hint;  ?>">
          </label>
          <label class="input-text-field">
            <?php echo $documents_add_document_number_label; ?>
            <input id="document_number" type="text" class="input-send"
          ...
          <label class="input-text-field">
            ...
            <input id="document_name" type="text" class="input-send"
          ...
          <label class="input-text-field">
            ...
            <textarea id="document_description" rows="4" type="text" class="input-send"
          ...
          <div class="end">
          <button
            onMouseDown="File_Form('<?php echo  $documents_add_document_button_href; ?>',[['item_guid','<?php echo  $item_guid; ?>']])">
            <?php echo $documents_add_add_document_button_text; ?>
          </button> 
          </div>
