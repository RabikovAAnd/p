        ...
        <div class="table-menu-style">
          ...
          <div id="<?php echo $group[ 'element_href' ]; ?>" class="properties-table table-menu-element">
            ...
            <div class="table-button-menu" style="display: none;">
              ...
              <a href="<?php echo $group[ 'activate_button_href' ]; ?>"
                title="<?php echo $workplace_properties_activate_button_hint; ?>">
                <button type="button">
                  <?php echo $workplace_properties_activate_button_text; ?>
                </button></a>
              <a href="<?php echo $group[ 'deactivate_button_href' ]; ?>"
                title="<?php echo $workplace_properties_deactivate_button_hint; ?>">
                <button type="button">
