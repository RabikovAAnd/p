...
<div id="content">
  <h1>
    <?php echo $workplace_units_groups_edit_header; ?>
  </h1>
    ...
    <div class="main-area">
      ...
      <div class="info-content-block">
        <div class="list">
          ...
          <label class="input-text-field">
            <?php echo $workplace_units_groups_edit_status_label; ?>
            <select id="status"  class="input-send"
              title="<?php echo $workplace_units_groups_edit_status_hint; ?>" required>              
          ...
          <div class="between">
            <a href="<?php echo $cancel_button_href; ?>">
              <button type="button">
                <?php echo $workplace_units_groups_edit_cancel_button_text; ?>
              </button>
            </a>
            <button
              onMouseDown="File_Form( '<?php echo $edit_button_href; ?>' )">
              <?php echo $workplace_units_groups_edit_save_button_text; ?>
            </button>
          </div>
        </div>
