<?php
class ControllerWorkplaceCustomersRelationshipsCorporateAdd extends Controller
{
  ...
  public function index()
  {
    ...
    else 
    {
      ...
      // Load messages
      $this->messages->Load( $this->data, 'workplace', 'customers_relationships_corporate_add', 'index', $this->language->Get_Language_Code() );
    ...
    foreach ( $customers as $customer )
    {
      ...
      // Compose links
      $this->data['add_customer_button_href'] = $this->url->link('workplace/customers/relationships/corporate/add/Add', 'guid=' .  $this->data['customer_guid'], 'SSL');
  ...
  public function Add()
  {
      ...
      // Load messages
      $this->messages->Load( $this->data, 'workplace', 'customers_relationships_corporate_add', 'Add', $this->language->Get_Language_Code() );
      ...
      if( $this->request->Is_GET_Parameter_GUID( 'guid' ) === false )
      {
        ...
        $json[ 'error' ][ 'guid' ] = $this->data[ 'workplace_customers_relationships_corporate_add_guid_error' ];
      ...
      if( $this->request->Is_POST_Parameter_GUID( 'customer_guid' ) === false )
      {
        ...
        // Set error message text
        $json[ 'error' ][ 'customer_guid' ] = $this->data[ 'workplace_customers_relationships_corporate_add_customer_guid_error' ];
      ...
      if ( $request_data_valid === true )
      {
        ...
        if ($data['parent_guid'] == $data['customer_guid'])
        {
          ...
          // Set error message text
          $json[ 'error' ][ 'same_guid' ] = $this->data[ 'workplace_customers_relationships_corporate_add_same_guid_error' ];
      ...
      if ( $request_data_valid === true )
      {
        ...
        if ($this->model_customers_customers->Is_Exist_Customers_Customer($data['parent_guid'], $data['customer_guid']))
        {
          ...
          // Set error message text
          $json[ 'error' ][ 'customer_exists' ] = $this->data[ 'workplace_customers_relationships_corporate_add_customer_exists_error' ];
