  ...
  public function login()
  {
    ...
    else
    {
      ...
      else
      {
        ...
        //--------------------------------------------------------------------
        $this->log->Log_Debug( 'email' .  $this->request->Get_POST_Parameter_As_String( 'email' ));
        $this->log->Log_Debug( 'password' .  $this->request->Get_POST_Parameter_As_String( 'password' ));
