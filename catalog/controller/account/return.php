...
//          $this->session->data['redirect'] = $this->url->link('account/return', '', 'SSL');
    ...
    $this->response->addScript('catalog/view/javascript/jquery/colorbox/jquery.colorbox-min.js');
    $this->response->addStyle('catalog/view/javascript/jquery/colorbox/colorbox.css');
...
//    $this->response->Set_HTTP_Output( $this->Render( 'account/return_list.tpl' ) );
  }
  ...
  public function info()
  {
    ...
    if ($return_info) {
      $this->response->setTitle($this->language->get('text_return'));
...
//      $this->response->Set_HTTP_Output($this->Render( 'account/return_info.tpl' ));
    } 
    else 
    {
...
//    $this->response->Set_HTTP_Output($this->Render( 'account/return_form.tpl' ) );
  }
...
//    $this->response->Set_HTTP_Output( $this->Render( 'common/success.tpl' ) );
...
// ANVILEX Begin : Phone is not requered field
